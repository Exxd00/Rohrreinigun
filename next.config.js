...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/:city/rohrreinigung", destination: "/:city", permanent: true },
      { source: "/:city/abflussreinigung", destination: "/:city", permanent: true },
      { source: "/:city/kanalreinigung", destination: "/:city", permanent: true },
      { source: "/:city/rohrreinigung-notdienst", destination: "/:city", permanent: true },
