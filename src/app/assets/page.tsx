...
const brandAssets = [
  {
    name: "Logo PNG (200x200)",
    description: "Standard Logo für Web",
    url: "/logo.png",
    type: "PNG",
  },
  {
    name: "Logo PNG (400x400)",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Laden Sie das hochauflösende Logo (400x400 px) herunter für WhatsApp und Social Media.
            </p>
            <div className="flex justify-center gap-4">
              <Button
                onClick={() => downloadAsset("/logo-lg.png", "rohrreinigung-kraft-logo.png")}
